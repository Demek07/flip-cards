    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorites_word', models.ManyToManyField(related_name='favorites_word', through='flip_cards_app.FavoritesWords', to=settings.AUTH_USER_MODEL, verbose_name='Избранные')),
            ],
            options={
                'verbose_name': 'Словo',
