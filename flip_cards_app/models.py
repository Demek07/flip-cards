...
# dump только базы Word - python -Xutf8 manage.py dumpdata flip_cards_app.Word --indent=2 > dump.json
# загрузка базы данных - python manage.py loaddata dump.json
from django.db import models
from django.contrib.auth import get_user_model


# python - Xutf8 manage.py dumpdata - -indent = 2 flip_cards_app.Word > dump.json
